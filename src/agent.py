"""
Google ADK root agent for FIFA 2026 Q&A. Connects to MongoDB tools and answers questions about
...
root_agent = Agent(
    ...
    2. When asked about stadiums or cities, use get_all_venues.
    3. When asked about teams or countries, use get_all_teams.
    4. When asked about games or fixtures, use get_all_matches.
